    ...
    useEffect(() => {
        if (isEditing) {
            ...
            getProductById(productId)
                ...
                .catch(err => setError("Não foi possível carregar o produto para edição." + (err.response?.data?.message || '')))
    ...
    return (
        <div style={{ padding: '20px', maxWidth: '600px', margin: 'auto' }}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    <label>Preço (R$):</label>
                    <input type="number" name="price" value={formData.price} onChange={handleChange} step="0.01" min="0.01" required />
                </div>
                <div>
                    <label>Estoque:</label>
                ...
                <div>
                    ...
                    <button type="button" onClick={addImageField}>+ Adicionar URL</button>
                </div>
                ...
                <div style={{ marginTop: '20px' }}>
                    ...
                    <Link to="/meus-produtos" style={{ marginLeft: '10px' }}>Cancelar</Link>
                </div>
            </form>
        </div>
    );
